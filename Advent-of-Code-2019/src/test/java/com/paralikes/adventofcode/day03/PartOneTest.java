...
class PartOneTest extends ChallengeTest<FileInput, Integer> {
	...
	public void testRequirements() throws ChallengeException {
		...
		assertEquals(6, challenge.calculate(wireDescriptions00));
		...
		assertEquals(159, challenge.calculate(wireDescriptions01));
		...
		assertEquals(135, challenge.calculate(wireDescriptions02));
	}
